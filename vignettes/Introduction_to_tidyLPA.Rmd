...
2. Make it easier to use the output in subsequent analysis through a ["tidy" interface](https://cran.r-project.org/web/packages/tidyverse/vignettes/manifesto.html), in that:
...
First, you can install the package from CRAN as follows (note: may not yet be available; if this does not work, you can still install tidyLPA with the approach below):
