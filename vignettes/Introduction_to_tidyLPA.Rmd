...
Here are the log-likelihoods for a series of models (models 1, 2, 3, and 6, specified by `models =` in `estimate_profiles()) for 2 and 3 profile solutions for the built-in (to R) [iris](https://en.wikipedia.org/wiki/Iris_flower_data_set) and [geyser](https://stat.ethz.ch/R-manual/R-devel/library/datasets/html/faithful.html) data.
